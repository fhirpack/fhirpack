...
If you experience bugs or general issues with ``fhirpack``, please have a look
...
You can help improve ``fhirpack`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``fhirpack`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``fhirpack``'s files. While this mechanism can
...
.. _repository: https://github.com/<USERNAME>/fhirpack
.. _issue tracker: https://github.com/<USERNAME>/fhirpack/issues
.. <-- end -->
