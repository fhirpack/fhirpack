...
import fhirdrill.custom.extraction.base as base
import fhirdrill.utils as utils


class PluginSampleExtractorMixin(base.PluginBaseExtractorMixin):
    def unimplementedPluginSampleExtractorMethod(
        self,
        input: Union[
            list[str],
